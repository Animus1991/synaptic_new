...
`B4 in progress (2026-07-12)` — `uploadValidation` (type/size/duplicate/URL), upload job id, processing close guard, sourceMode reset, modal a11y shell. **Pending:** full transaction rollback E2E matrix.
...
**Επόμενη επιτρεπτή ενέργεια:** **B4 finish** (upload E2E matrix) ή **B5** κατά §29.3.
