...
export function StudyGuideExportButton({ course, glossaryEntries = [], lang, className }: Props) {
  ...
  return (
    <button
      ...
      className={cn(
        'inline-flex items-center gap-2 px-3 py-2 rounded-xl type-meta border border-border-subtle hover:bg-surface-hover text-text-secondary transition-colors',
        className,
      )}
      title={label}
    >
