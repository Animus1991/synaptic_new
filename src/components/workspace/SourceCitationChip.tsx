...
export function SourceCitationChip({ citation, onOpenInReader, className = '' }: Props) {
  ...
  return (
    <button
      ...
      className={`inline-flex items-center gap-1 rounded-full border border-brand-500/30 bg-brand-500/10 px-2 py-0.5 text-[9px] font-medium text-brand-800 hover:opacity-90 ${className}`}
