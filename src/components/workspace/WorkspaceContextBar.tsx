...
export function WorkspaceContextBar({
    ...
    <>
      ...
      {showNextAction && onNextAction && (
        <button
          ...
          className="ws-eyebrow inline-flex shrink-0 items-center gap-1 rounded-full border border-brand-500/35 bg-brand-500/10 px-2 py-0.5 type-caption text-text-secondary hover:bg-brand-500/15"
  ...
  return (
    ...
    >
      ...
      {focusConcept && (
        <span
          className="ws-eyebrow max-w-[8rem] truncate shrink rounded-full border border-brand-500/30 bg-brand-500/10 px-2 py-0.5 type-caption text-text-secondary"
