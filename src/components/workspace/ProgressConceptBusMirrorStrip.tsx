        ...
        <>
          {onExportHtml && report.exportIncludesBus && (
            <button
              ...
              className="ws-chip-brand inline-flex shrink-0 items-center gap-1 rounded-lg px-2 py-1 type-caption font-medium"
            >
          ...
          {!report.ok && (
            <span className="shrink-0 type-caption opacity-90">{t('checkLabel', lang)}</span>
          )}
        </>
      }
    >
