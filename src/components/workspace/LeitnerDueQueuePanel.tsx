          ...
          return (
            <li key={`${item.concept}-${item.dueAt}`}>
              <button
                ...
                className={cn(
                  'w-full text-left rounded-lg transition-colors hover:bg-surface-secondary/70 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500/50',
