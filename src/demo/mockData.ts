...
export const mockCourses: Course[] = [
  {
    ...
    topics: [
      ...
      mkTopic('t2', 'Consumer Theory', 'Utility, preferences, and budget constraints', 78, ['Supply & Demand'], 2, false, 60, 12),
      mkTopic('t3', 'Elasticity', 'Price, income, and cross elasticity', 65, ['Supply & Demand'], 3, false, 40, 6),
      mkTopic('t4', 'Market Structures', 'Perfect competition, monopoly, oligopoly', 45, ['Supply & Demand', 'Consumer Theory'], 4, false, 75, 14),
      mkTopic('t5', 'Welfare Economics', 'Efficiency, equity, and market failures', 20, ['Supply & Demand', 'Market Structures'], 5, false, 50, 9),
      mkTopic('t6', 'Game Theory Basics', 'Strategic interaction and Nash equilibrium', 0, ['Market Structures'], 6, true, 55, 10),
    ],
  ...
  },
  {
    ...
    topics: [
      ...
      mkTopic('t8', 'NumPy Arrays', 'Array operations and broadcasting', 82, ['Python Basics Review'], 2, false, 50, 8),
      mkTopic('t9', 'Pandas DataFrames', 'Data manipulation and analysis', 70, ['NumPy Arrays'], 3, false, 60, 12),
      mkTopic('t10', 'Data Visualization', 'Matplotlib and Seaborn', 55, ['Pandas DataFrames'], 4, false, 45, 7),
      mkTopic('t11', 'Machine Learning Intro', 'Scikit-learn basics', 30, ['Pandas DataFrames'], 5, false, 70, 11),
    ],
  ...
  },
  {
    ...
    topics: [
      ...
      mkTopic('t13', 'Epistemology', 'Knowledge, belief, and justification', 40, ['What is Philosophy?'], 2, false, 55, 9),
      mkTopic('t14', 'Ethics', 'Consequentialism, deontology, virtue ethics', 10, ['What is Philosophy?'], 3, false, 60, 11),
      mkTopic('t15', 'Philosophy of Mind', 'Consciousness, dualism, physicalism', 0, ['What is Philosophy?', 'Epistemology'], 4, true, 50, 8),
    ],
...
export const mockAgentMessages: AgentMessage[] = [
  { id: 'msg1', role: 'system', content: 'Tutor: Socratic · Source: Microeconomics Lecture Notes · My notes only', timestamp: '2026-01-15T09:30:00', type: 'text' },
