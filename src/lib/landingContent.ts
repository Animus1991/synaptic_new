...
const LANDING: Record<Lang, LandingContent> = {
  ...
  el: {
    ...
    ctaSecondary: 'Δοκίμασε το demo δοκιμής',
    getStarted: 'Ξεκίνα',
    trust: ['Χωρίς πιστωτική κάρτα', 'Για κάθε αντικείμενο', 'AI με βάση τις πηγές σου'],
    features: [
      { title: 'Ανέβασμα Οτιδήποτε', desc: 'PDF, διαφάνειες, σημειώσεις, εικόνες, κώδικας, απομαγνητοφωνήσεις.' },
      ...
      { title: 'Διαδραστική Εξάσκηση', desc: 'Κουίζ, προγραμματισμός, σωκρατικός διάλογος, προσομοίωση εξετάσεων.' },
      { title: 'Διαστημική επανάληψη', desc: 'Επιστημονικά χρονομετρημένες επαναλήψεις.' },
      { title: 'Αναλυτικά Μάθησης', desc: 'Χάρτες κατάκτησης, αδύναμα σημεία, λάθη και διατήρηση γνώσης.' },
    ],
    userTypes: [
      ...
      { label: 'Καθηγητές & εκπαιδευτές', desc: 'Διαδραστικά μαθήματα άμεσα' },
      { label: 'Εταιρείες', desc: 'Εκπαιδευτικά modules από εγχειρίδια' },
    ],
    steps: [
      { num: '01', title: 'Ανέβασε Υλικό', desc: 'Σημειώσεις, PDF, διαφάνειες ή επικόλληση.' },
      { num: '02', title: 'Ανάλυση AI', desc: 'Θέματα, έννοιες, προαπαιτούμενα — αυτόματα.' },
      { num: '03', title: 'Μάθε Διαδραστικά', desc: 'Μαθήματα, εξάσκηση, κουίζ, σωκρατική διδασκαλία.' },
    ...
    featuresSectionSubtitle: 'Γνωστική επιστήμη, όχι κόλπα',
    diffTitle: 'Όχι Ακόμα ένα AI Chat',
    diffSubtitle: 'Το Synapse ανακαλύπτει πώς μαθαίνεις από τη συμπεριφορά σου.',
    diffItems: [
      { wrong: '❌ Σταθερά «στυλ μάθησης»', right: '✅ Προσαρμοστικό μοντέλο από συμπεριφορά' },
      { wrong: '❌ Γενικό chat', right: '✅ Πλήρες μάθημα με παρακολούθηση κατάκτησης' },
      { wrong: '❌ Μόνο κάρτες επανάληψης', right: '✅ Μαθήματα, κουίζ, προετοιμασία εξετάσεων' },
      { wrong: '❌ Περιεχόμενο χωρίς πηγές', right: '✅ Απαντήσεις με παραπομπές στις πηγές σου' },
      { wrong: '❌ Ίδιος ρυθμός για όλους', right: '✅ Προσαρμογή δυσκολίας' },
      { wrong: '❌ Παθητική ανάγνωση', right: '✅ Ενεργή ανάκληση' },
    ],
    testimonialQuote: 'Ανέβασα τις σημειώσεις μου και έγιναν διαδραστικό μάθημα από το δικό μου υλικό.',
    testimonialAuthor: 'Φοιτητής · μάθηση με βάση τις σημειώσεις',
