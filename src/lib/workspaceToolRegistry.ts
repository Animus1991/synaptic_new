...
export const WORKSPACE_TOOLS: WorkspaceToolMeta[] = [
  ...
  { id: 'feynman', icon: Lightbulb, label: 'Feynman', labelEl: 'Feynman', desc: 'Explain simply', descEl: 'Εξήγηση με δικά σου λόγια' },
  { id: 'quiz', icon: HelpCircle, label: 'Quiz', labelEl: 'Κουίζ', desc: 'Active recall check', descEl: 'Έλεγχος γνώσης (active recall)' },
  ...
  { id: 'annotations', icon: Highlighter, label: 'Annotations', labelEl: 'Επισημάνσεις', desc: 'Highlights on source', descEl: 'Επισημάνσεις στο κείμενο' },
