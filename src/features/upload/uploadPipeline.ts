...
import { extractTextFromFile, type FileExtractResult } from '../../lib/pdfExtract';
import { inferSubject, rankKeyphrases, titleCasePhrase } from '../../lib/contentAnalysis';
import type { GeneratedOutline } from '../../lib/courseGenerator';
import { buildGlossaryEntriesFromOutline } from '../../lib/courseMerge';
import { CONTENT_PIPELINE_VERSION } from '../../lib/pipelineConstants';
import { DEFAULT_COURSE_ICON_ID } from '../../lib/uiIconRegistry';
import { buildDocumentModelInWorker } from '../../lib/documentModelWorkerClient';
import {
...
} from '../../lib/documentModelSnapshot';
import { applyQualityGatesToCourse } from '../../lib/courseQualityGates';
import { buildOutlinePreviewFromCourse } from '../../lib/courseSourceQuality';
