# Wave I β€” Mockup screenshot fidelity (post H+)

**Date:** 2026-07-16  
**Branch:** `feat/mockup-implementation` β†’ `https://github.com/Animus1991/synaptic_new.git` only  
**Inputs:** 10 Replit canvas screenshots (DashboardΓ—3, TasksΓ—2, LibraryΓ—2, AnalyticsΓ—3)  
**Non-negotiables:** 100% tool functionality Β· denser type than Replit Β· **no emojis** Β· Phosphor/line icons Β· warm light + dark first-class Β· no secrets/PII in commits Β· merge best of production + canvas (no wholesale replacement)
...
**Density contract:** H1 β‰ 18β€“20px Β· section labels 11β€“13px uppercase Β· cards `p-3`/`p-4` Β· KPI `text-xl` Β· zero emoji chrome.

---

## 2. Already shipped (do not redo)

Wave Aβ€“G + H-01β€¦H-05: hub CTAs, stats, warm-sand, Tasks dual strip, Library RAG/NotebookLM, Analytics tabs/KPI/Visual Lab prefs, 3-col dashboard toggle, combined-study panel, TOOL-RD-03, AI-05 NotebookLM strategy.
...
## 4. Sprint I-1 (this wave β€” P1)

| ID | Surface | Item | Status |
| -- | ------- | ---- | ------ |
| I-D01 | Dashboard | Move coverage / exam calendar / next steps into right rail | **shipped** |
| I-D02 | Dashboard | 2Γ—2 semantic alert grid (exam / quiz / forget / misconception) | **shipped** |
| I-D04 | Dashboard | Primary **Ξ•ΞΊΟ„Ξ­Ξ»ΞµΟƒΞ·** CTA on next-action | **shipped** |
...
| I-L01 | Library | Combined-study promo strip + Ξ•Ο€ΞΉΞ»ΞΏΞ³Ξ® expand | **shipped** |
| I-L02 | Library | Stats strip N courses / N files | **shipped** |
| I-L03 | Library | Explicit Ξ†Ξ½ΞΏΞΉΞ³ΞΌΞ± + Shell on course cards | **shipped** |
| I-A01 | Analytics | Overview 3-col: Courses \| Concepts \| You vs Real | **shipped** |
| I-A02 | Analytics | Overview section order (KPI β†’ ring β†’ FSRS β†’ trends β†’ 3-col β†’ flow β†’ lab) | **shipped** |
...
| I-T02 | Ξ”Ξ·ΞΌΞΉΞΏΟΟΞ³Ξ·ΟƒΞµ Ξ Ξ»Ξ¬Ξ½ΞΏ CTA | P2 | **shipped** |
| I-T03 | Weak-area trend colors (emerald / rose / muted) | P2 | **shipped** |
| I-T04 | Due review interval badge | P2 | **shipped** |
| I-L04β€“L08 | Corner badges, generating lock, topic chips, +Ξ‘ΟΟ‡ΞµΞ―ΞΏ, X delete | P2β€“P3 | **shipped** |
...
- Push target: **Animus1991/synaptic_new** Β· **feat/mockup-implementation** only.
...
- [x] 2Γ—2 alert grid visible when data present
- [x] Tasks: sessions β†’ tabs β†’ insights β†’ list
