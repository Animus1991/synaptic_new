...
| ID | Item |
| -- | ---- |
| TOOL-CM-03 | PMI edge labels |
| TOOL-CM-04 | Keyboard a11y + SR tree |
| TOOL-RD-02 | Glossary popover |
| TOOL-SM-02/03 | Simulator presets + graph→whiteboard |
| TOOL-PR-02/03 | Time-on-tool + PDF progress export |
| MD-05 | Image-as-thumbnail |
| XTL-03 | Expand RTL component tests |
...
| Waves 2–5 | scheduled — continue sprint-by-sprint without breaking Google paths |
