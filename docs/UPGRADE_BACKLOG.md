...
| H | Full-app page loop | **in progress** — H1–H5 + **S1 done**; remaining Wave I items |
...
| I1 | Spectrum/light clarity parity | **partial** — first slice: nav where-am-I pill, type roles, quiet icons, full remaining width on spectrum + light (Minimal pins unchanged). Brand washes stay Minimal-only (`waveStudySurfacesContract.test.ts`) |
