...
| H | Full-app page loop | **in progress** — H1 Landing hero budget (CTA before intents + inline chips); **next H2** Dashboard hero densify (screenshot-led); **H3** Settings nav/section density |
